...
def change_case(text: str, case: str = 'lower') -> str:
    ...
    - mode (str): The type of case - either 'lower', 'upper', 'title', or 'capitalize'. Defaults to 'lower'.
...
def remove_email(text: str, use_mask: bool = True, mask: str = '<EMAIL_ADDRESS>'):
    """
...
def remove_phone(text: str, use_mask: bool = True, mask: str = '<PHONE_NUMBER>'):
    """
...
def remove_social(text: str, use_mask: bool = True, mask: str = '<SOCIAL_SECURITY_NUMBER>'):
    """
